...
class RiskScoreService:
    def __init__(self, db: Session, neo4j_session: Neo4jSession, redis_client: Redis | None = None):
    ...
    def calculate_risk_score(self, account_id: str) -> RiskScoreResponse:
        ...
        # 2. Fetch graph signals from Neo4j
        ...
        # Factor 2: Txn Frequency Score (scaled logarithmically or relative to threshold)
        # e.g., > 10 txns => 100 score, linear up to 10
        ...
        explainable_factors = {
            ...
            "linked_accounts": f"{total_linked} distinct linked counterparty account(s).",
            "graph_centrality": f"Degree centrality score of {centrality['degree_centrality']} (In: {centrality['in_degree']}, Out: {centrality['out_degree']})."
        }
